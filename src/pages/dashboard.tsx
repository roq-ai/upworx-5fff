...
import { useJobOfferCount, useFreelancerProfileCount, useApplicationCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const freelancerProfileStat = useFreelancerProfileCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: freelancerProfileStat?.data,
